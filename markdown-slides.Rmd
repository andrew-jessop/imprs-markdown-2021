...
- Analysis notebooks in RMarkdown

- APA reports using RMarkdown
...
- R ([R Projects](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects), [RMarkdown](https://bookdown.org/yihui/rmarkdown/), [Jupyter](https://www.datacamp.com/community/blog/jupyter-notebook-r), [renv](https://rstudio.github.io/renv/))
...
- [PDF in R markdown](https://github.com/andrew-jessop/apa-pdf-in-rmarkdown)

- [DOCX in R markdown](https://github.com/andrew-jessop/apa-word-docx-in-rmarkdown)
